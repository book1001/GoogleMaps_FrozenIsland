...
function initMap() {
  ...
  google.maps.event.addListener(streetView, 'visible_changed', function() {
    ...
    if (visible) {
      ...
      // markers.forEach(m => m.icon.size = new google.maps.Size(800, 800));
      // markers.forEach(m => m.icon.scaledSize = new google.maps.Size(800, 800));

      // document.getElementsByClassName('gm-iv-container')[0].style.display="none";
      // document.getElementsByClassName('gm-iv-container')[1].style.display="none";
      // var changeClass = document.getElementsByClassName("gm-iv-container");
      ...
      console.log("MapView");
      // markers.forEach(m => m.icon.size = new google.maps.Size(50, 50));
      ...
      // document.getElementById('iconBody1').style.display="none";
    }
    isVisible = visible;
  });
  ...
  const markers = [
    ...
    [
      "Hopeville Pond State Boat Launch",
      41.6073884,
      -71.9266828,
      "./icons/MarioPipe.png",
      25,
